    ...
    <div className="min-h-screen bg-paper">
      ...
      <main className="mx-auto max-w-3xl px-5 pb-16">
        ...
        >
          ...
          <blockquote className="my-4 rounded-lg border-l-[3px] border-eco bg-surface px-4 py-3 text-[15px] leading-relaxed text-ink-soft">
            <strong className="font-semibold text-ink">
        ...
        <p className="pt-6 text-[13px] italic text-ink-muted">
