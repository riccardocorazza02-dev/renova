-- ════════════════════════════════════════════════════════════════
-- Loop · setup_all.sql — Schema COMPLETO (migrazioni 0001 → 0016)
-- ════════════════════════════════════════════════════════════════
...
--
-- 2) Le conversazioni si AUTO-ELIMINANO dopo 1 mese di inattività (nessun
--    nuovo messaggio → updated_at). NB: il criterio "scambiato da oltre una
--    settimana" è stato rimosso in 0017 (la chat resta dopo lo scambio).
...
begin
  with del as (
    ...
    -- (la chat NON si elimina dopo lo scambio — cfr. 0017)
